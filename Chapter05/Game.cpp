...
void Game::CreateSpriteVerts()
{
	float vertices[] = {
		...
		-0.5f,  0.5f, 0.f,  1.0f, 0.0f, 0.0f,   0.f, 0.f, // top left
		 0.5f,  0.5f, 0.f,  0.0f, 1.0f, 0.0f,   1.f, 0.f, // top right
		 0.5f, -0.5f, 0.f,  0.0f, 0.0f, 1.0f,   1.f, 1.f, // bottom right
		-0.5f, -0.5f, 0.f,  1.0f, 0.0f, 1.0f,   0.f, 1.f  // bottom left
	};
